...
const token = '6173590523:AAGDc74zK5iwJrTE18n8911_X71kzPqHIkU';
const webAppURL = 'https://steady-clafoutis-c61874.netlify.app/';
...
bot.on('message', async (msg) => {
  ...
  if (msg?.web_app_data?.data) {
    try {
      ...
      setTimeout(async () => {
        await bot.sendMessage(chatId, 'Вcю информацию вы получите в этом чате');
      }, 3000);
    } catch (error) {
      console.log(e);
    }
...
app.post('/wep-data', async (req, res) => {
